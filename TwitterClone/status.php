        ...
        <div class="sidebar-left">
          ...
          <div class="grid-sidebar bg-active" style="margin-top: 100px">
            ...
            <div class="wrapper-left-elements">
              <a class="wrapper-left-active" href="home.php" style="margin-top: 4px; "><strong>&nbsp&nbspHome</strong></a>
            </div>
          </div>
          </a>
          ...
          <div class="grid-sidebar">
            ...
            <div class="wrapper-left-elements">
              ...
              <a  href="<?php echo BASE_URL . $user->username; ?>"  style="margin-top: 4px"><strong>&nbsp&nbspProfile</strong></a>
      ...
      <div class="grid-posts">
        <div class="border-right">
          ...
          <?php foreach($comments as $comment) { 
                     ...
                     $user_like_comment = Comment::userLikeComment($user_id, $comment->id);
                     $comment_likes_count = Comment::countLikes_comment($comment->id);
                 
                     if (isset($_POST['comment_like_button'])) {
                         $user_id = $_SESSION['user_id']; // 현재 사용자의 ID
                         $comment_id = $_POST['comment_id'];
                         $comment_likes_count = Comment::countLikes_comment($comment_id);
                     }
          ?>
            ...
            <div class="grid-tweet">
              ...
              <div>
                ...
                <div class="grid-reactions">
                  ...
                  <div  class="grid-box-reaction-rep"> 
                    <a class="hover-reaction-rep hover-reaction-like
                        <?= $user_like_comment ? 'unlike-btn' : 'like-btn' ?> " 
                      data-tweet="<?php 
                        echo $comment->id ;
                      ?>" 
                      data-user="<?php 
                      ...
                      <i class="fa-heart <?= $user_like_comment ? 'fas' : 'far mt-icon-reaction' ?>"></i>
                      <div class="mt-counter likes-count d-inline-block">
                        <p > <?php if($comment_likes_count > 0) echo $comment_likes_count; ?> </p>
                      </div>
