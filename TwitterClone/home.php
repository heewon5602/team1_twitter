...
<head>
    ...
    <title>Home | Twitter_team1</title>
  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is Twitter is developed by <span style="font-weight: 700;">team 1</span></p>
                      ...
                      <form class="" action="handle/handleTweet.php" method="post" enctype="multipart/form-data">
                        <div class="inner">
                          ...
                          <label>
                            ...
                            <textarea class="text-whathappen" name="status" rows="8" cols="80" placeholder="Write your issues."></textarea>
