...
<script src="assets/js/jquery-3.5.1.min.js"></script>
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <a href="home.php">
            <div style="margin-top: 12px">
              <div class="icon-sidebar-align">
                ...
                <a class="wrapper-left-active" href="home.php" style="margin-top: 4px; font-size: 30px;"><strong>&nbsp&nbspTwitter_team1</strong></a>
              </div>
            </div>
          </a>
          ...
          <a href="home.php">
          <div class="grid-sidebar bg-active" style="margin-top: 100px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "includes/icons/home_icon.png"; ?>" alt="" style="margin-left: 20px; " height="26.25px" width="26.25px" />
            </div>
            <div class="wrapper-left-elements">
              <a href="home.php" style="margin-top: 4px;"><strong>&nbsp&nbspHome</strong></a>
            </div>
          </div>
          </a>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "includes/icons/profile_icon.png"; ?>" alt="" style="margin-left: 20px; " height="26.25px" width="26.25px" />
            </div>

            <div class="wrapper-left-elements">
              <!-- <a href="/twitter/<?php echo $user->username; ?>"  style="margin-top: 4px"><strong>Profile</strong></a> -->
              <a class="wrapper-left-active" href="<?php echo BASE_URL . $user->username; ?>"  style="margin-top: 4px"><strong>&nbsp&nbspProfile</strong></a>
          ...
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "includes/icons/setting_icon.png"; ?>" alt="" style="margin-left: 20px; " height="26.25px" width="26.25px" />
            </div>
  
            <div class="wrapper-left-elements">
              <a href="<?php echo BASE_URL . "account.php"; ?>" style="margin-top: 4px"><strong>&nbsp&nbspSettings</strong></a>
            </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align">
            <img src="<?php echo BASE_URL . "includes/icons/logout_icon.png"; ?>" alt="" style="margin-left: 20px; " height="26.25px" width="26.25px" />
            </div>
  
            <div class="wrapper-left-elements">
              <a href="includes/logout.php" style="margin-top: 4px"><strong>&nbsp&nbspLogout</strong></a>
            </div>
          </div>
          </a>
      ...
      <div class="grid-posts">
                 ...
                 <div class="row justify-content-between">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <input type="text" name="comment" class="form-control" id="exampleInputEmail1" value="<?php if ($user->comment !== null) 
                            echo $user->comment ;?>" aria-describedby="emailHelp" placeholder="Bio">
                            </div>
                  ...
                  <?php } ?>
                  <p><br></p>
                    <p class="comment"><?php echo $profileData->comment; ?> </p>
                  </div>
                  ...
                  <div class="row home-follow ml-2 mt-1">
                      <div class="col-md-3">
                          ...
                          data-follow = "<?php echo $profileData->id; ?>" >
                           <span class="home-follow-count count-following"><?php echo Follow::countFollowing($profileData->id); ?></span> Followings</div>
                      </div>
                      <div class="col-md-3">
                         <div class="count-followers-i"
                         data-follow = "<?php echo $profileData->id; ?>"> 
                         <span class="home-follow-count count-followers"><?php echo Follow::countFollowers($profileData->id); ?></span> Followers</div>
                      </div>   
                  </div>
        ...
        <div class="wrapper-right">
            ...
            <div class="box-share">
            <p class="txt-share"><strong>Follow others</strong></p>
            <?php 
